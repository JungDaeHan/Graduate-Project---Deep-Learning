...
def Alexnet(width, height, depth, classes):
    ...
    # Conv1 + RELU + MaxPool1 ( 32x32x3 -> 16x16x64)
    ...
    # Conv2 + RELU + Maxpool2 ( 16x16x64 -> 8x8x192)
    ...
    # Conv3 + RELU ( 8x8x192 -> 8x8x384)
    model.add(Conv2D(384, (3,3),padding='same'))
    model.add(Activation("relu"))
    model.add(BatchNormalization())
    model.add(Dropout(0.25))
    
    # Conv4 + RELU( 8x8x384 -> 8x8x256)
    model.add(Conv2D(256, (3,3),padding='same'))
    model.add(Activation("relu"))
    model.add(BatchNormalization())
    model.add(Dropout(0.25))
    
    # Conv5 + RELU( 8x8x256 -> 3x3x256)
    model.add(Conv2D(256, (3,3),padding='same'))
    model.add(Activation("relu"))
    model.add(BatchNormalization())
...
model = Alexnet(width = 32, height = 32, depth = 3, classes = 10)
